// create a new module
angular.module('ionapp.oauthapp', []).controller('LoginCtrl', function ($scope, $state, $cookieStore) {
    ...
    $scope.fbLogin = function () {
        FB.login(function (response) {
            ...
            scope: 'email'
            //display: 'popup', // options for login popup
            }
    ...
    /*$scope.gplusLogin = function () {
        var myParams = {
            ...
            'clientid': '18301237550-3vlqoed2en4lvh88o2h1l9m70tr.apps.googleusercontent.com',
